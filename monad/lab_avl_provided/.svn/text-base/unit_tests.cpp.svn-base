...
{
    vector<pair<size_t, string>> elems = {{55, ""},
                                          {45, ""},
                                          {12, ""},
                                          {34, ""},
                                          {56, ""},
...
{
    vector<pair<size_t, string>> elems = {{55, "1"},
                                          {45, "1"},
                                          {12, "1"},
                                          {34, "1"},
                                          {56, "1"},
