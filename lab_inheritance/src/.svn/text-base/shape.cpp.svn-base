...
const epng::rgba_pixel DEFAULT_COLOR = color::BLACK;
...
Shape::Shape(const Vector2& pcenter, const epng::rgba_pixel& pcolor)
...
bool Shape::contains(const Vector2&) const
{
...
epng::rgba_pixel Shape::color() const
{
    return this->color_;
}

void Shape::draw(epng::png& canvas) const
{
